document.addEventListener('DOMContentLoaded', () => {
   ...
   //move tetromino to the right, unless is at the edge or there is a blockage---------------------------------------->
   function moveRight() {
       undraw()
   ...
   function rotate() {
       undraw()
       currentRotation ++
       if(currentRotation === current.length) {  //if current Rotation is at the 4th index position, it goes back to 0, looping back through again----->
           currentRotation = 0
       }
       current = theTetrominoes[random][currentRotation]
       draw()
